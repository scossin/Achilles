...
(
  select 
    ...
    count_big(*) as cnt from @cdmDatabaseSchema.measurement
  ...
  select 
    ...
    count_big(*) as cnt 
  from @cdmDatabaseSchema.condition_occurrence 4
  ...
  select 
    ...
    count_big(*) as cnt from @cdmDatabaseSchema.observation
  ...
  {@cdmVersion not in ('5', '5.0', '5.0.0', '5.1', '5.1.0', '5.2', '5.2.0')}?{
    ...
    select
      ...
      visit_detail_source_value as source_value, 
      count_big(*) as cnt 
    from @cdmDatabaseSchema.visit_detail
    where visit_detail_concept_id = 0 
    group by visit_detail_source_value
  }
  ...
  select 
    ...
    count_big(*) as cnt from @cdmDatabaseSchema.device_exposure
