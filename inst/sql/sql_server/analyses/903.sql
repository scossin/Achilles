...
(
  select 
    COUNT_BIG(distinct de1.drug_concept_id) as count_value
	from @cdmDatabaseSchema.drug_era de1 
  join @cdmDatabaseSchema.observation_period op on de1.person_id = op.person_id
  where de1.drug_era_start_date <= op.observation_period_end_date
    and isnull(de1.drug_era_end_date,de1.drug_era_start_date) >= op.observation_period_start_date
